...
noa.registry.registerMaterial('stone', {/*textureURL:"/stone.png"*/texHasAlpha:!0,color:[0.5,0.5,0.5,0.3]}); //stone
...
function getVoxelID(x, y, z,height,data) {
	...
	if(shouldBeTest(x,y,z,0.88,0.02)&&(y<amount-6&&y<=144))return BLOCK_TO_ID["coal_ore"];
